...
data class TileData(val char: Char, val status: TileKeyStatus, val columnPosition: Int = 0) : TileKeyData()

data class KeyData(val char: Char?=null, val keyType: KeyType, val status: TileKeyStatus) : TileKeyData()
